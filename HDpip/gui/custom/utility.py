...
@overload
def smartScale(value: int | decimal.Decimal, base_size: tuple[int, int] = ..., screen_size: tuple[int, int] = ..., *, strict_mode: bool = ..., use_cache: bool = ..., return_type: Literal["Decimal"]) -> decimal.Decimal: ...
@overload
